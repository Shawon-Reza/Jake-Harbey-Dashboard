        ...
        <div className="bg-[#F2F2F2] mx-auto p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10 bg-white p-10">
            <div className="col-span-2 grid grid-cols-2 gap-10">
              ...
              {/* Documents Section */}
              <div className="bg-[#F9FAFB] rounded-[32px] p-8 border border-[#E7E7E7] shadow-sm mb-10 col-span-2">
                <div className="flex items-center justify-between mb-10">
                ...
                <div className="flex gap-10 mb-8 border-b border-[#E5E7EB]">
                  {[
                    ...
                    >
                      {tab.name}{" "}
                      <span className="ml-1 text-xs opacity-60 text-[#6B7280]">
                        {tab.count}
                      </span>
                      {idx === 0 && (
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-10 border border-[#E7E7E7] shadow-sm mb-10">
            ...
            <div className="space-y-4">
              {tech.assignedJobs.map((job) => (
                <div
                  key={job.id}
                  className="bg-white p-6 rounded-2xl flex items-center justify-between shadow-sm border border-[#F3F4F6]"
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <p className="font-medium text-[#2A2A2A] text-lg">
                        {job.name}
                      </p>
