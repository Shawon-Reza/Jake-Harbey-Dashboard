                ...
                <div className="mx-auto p-12">
                    ...
                    <div className="bg-white rounded-xl border border-[#E7E7E7] shadow-sm overflow-hidden mb-10">
                        ...
                        <div className="bg-[#044D5C] p-12 py-6 flex items-center gap-10 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className={`w-24 h-24 rounded-full border-4 border-white flex items-center justify-center text-4xl text-[#454545] ${getAvatarColor(customer.id)}`}>
                                    {getInitial(customer.name)}
                                </div>
                            </div>
                            <div className="text-white relative z-10">
                                <h2 className="text-2xl mb-2 tracking-tight">{customer.name}</h2>
                                <p className="text-teal-50/70 text-lg">Customer since {customer.since}</p>
                            </div>
                        </div>
                                    ...
                                    <div className="">
                                        {[
                                            ...
                                            <div key={info.label} className="flex border-b border-[#F5F5F5] pb-4 last:border-0">
                                                ...
                                                <span className="text-[#454545] text-lg flex-1">: {info.value}</span>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-6 h-fit">
                                    ...
                                    <div className="bg-[#E4F8FB] rounded-xl p-6 border border-blue-50 relative group hover:shadow-xl transition-all">
                                        <div className="flex items-center gap-4 mb-8">
                                            ...
                                            <div className="text-3xl text-[#1A9C9C]">{customer.jobs}</div>
                                        </div>
                                        <div>
                                    ...
                                    <div className="bg-[#F6FFFA] rounded-xl p-6 border border-green-50 relative group hover:shadow-xl transition-all">
                                        <div className="flex items-start justify-between mb-8 text-[#28A745]">
                                            ...
                                            <div className="text-3xl">{customer.totalSpent}</div>
                                        </div>
                                        <div>
                                    ...
                                    <div className="bg-white rounded-xl p-6 border border-[#E7E7E7] relative group hover:shadow-xl transition-all">
                                        ...
                                        <div className="text-3xl text-[#454545]">1</div>
                                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-[#E7E7E7] shadow-sm overflow-hidden">
                        <div className="p-10 py-4 border-b border-[#F5F5F5] flex items-center justify-between bg-[#F9FAFB]">
                            ...
                            <span className="text-[#6B7280]">{customer.submissions.length} total submissions</span>
                        </div>
                                    ...
                                    <div className="flex items-start justify-between gap-8">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-4 mb-4">
                                                <h4 className="text-xl text-[#2A2A2A]">{sub.service}</h4>
                                                <div className="flex gap-2.5">
                                                    {sub.status && <span className="bg-[#E4F8FB] text-[#1A9C9C] px-5 py-2 rounded-full text-xs shadow-sm">{sub.status}</span>}
                                                    {sub.urgency && <span className="bg-[#FFF4E5] text-[#F68528] px-5 py-2 rounded-full text-xs shadow-sm">{sub.urgency}</span>}
                                                    {sub.assign && <span className="bg-[#EEF2FF] text-[#818cf8] px-5 py-2 rounded-full text-xs shadow-sm flex items-center gap-2"><ArrowRight size={14} /> {sub.assign}</span>}
                                                </div>
                                            </div>
                                            <p className="text-[#4B5563] max-w-2xl mb-6">{sub.description}</p>
                                ...
                                >
                                    <td className="px-10 py-5">
                                        <div className="flex items-center gap-6">
                                            <div className={`w-16 h-16 rounded-full flex items-center justify-center text-xl font-semibold text-[#1D4ED8] shadow-sm bg-[#DBEAFE]`}>
                                                {getInitial(customer.name)}
                                            </div>
                                            <div>
                                                <p className="text-lg text-[#2A2A2A] mb-1 group-hover:text-[#1A9C9C] transition-colors">{customer.name}</p>
                                    ...
                                    <td className="px-10 py-4">
                                        <p className="flex items-center gap-3  text-[#454545]">
                                            <MapPin className="w-6 h-6 text-[#9CA3AF]" /> {customer.location}
                                        </p>
                                    </td>
                                    <td className="px-4 py-4">
                                        <p className=" text-[#2A2A2A]">{customer.jobs} Job{customer.jobs !== 1 ? 's' : ''}</p>
                                    </td>
                                    <td className="px-4 py-4">
